...
*/
public class SausagePie extends Pie implements TaxAcceptance, RecipeAcceptance {

	double netPrice; // timi xwris fpa

	public SausagePie(Crust crust, double netPrice) {
		super(crust);
	...
	@Override
	public void cook() {
		System.out.print("Ftiaxnw loukanikopita ");
		crust.useCrust();
	}
